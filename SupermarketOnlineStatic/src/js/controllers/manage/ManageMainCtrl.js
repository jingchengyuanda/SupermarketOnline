(function () {
  ...
  ctrls.controller('ManageMainCtrl', ['$scope', '$log', '$location', 'DataService',
    'DialogService', ManageMainCtrl
  ]);

  function ManageMainCtrl($scope, $log, $location, DataService, DialogService) {
