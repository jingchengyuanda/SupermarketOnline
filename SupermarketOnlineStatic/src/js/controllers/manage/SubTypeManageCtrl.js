(function () {
  ...
  ctrls.controller('SubTypeManageCtrl', ['$scope', '$log', 'DataService',
    'DialogService', SubTypeManageCtrl
  ]);

  function SubTypeManageCtrl($scope, $log, DataService, DialogService) {
    ...
    // 启用和禁用
    $scope.changeEnable = function (TbSubType, enable) {
