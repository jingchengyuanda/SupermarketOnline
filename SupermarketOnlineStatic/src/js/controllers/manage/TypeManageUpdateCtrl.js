(function () {
  ...
  ctrls.controller('TypeManageUpdateCtrl', ['$scope', '$log', 'DataService',
    'DialogService', TypeManageUpdateCtrl
  ]);

  function TypeManageUpdateCtrl($scope, $log, DataService, DialogService) {
